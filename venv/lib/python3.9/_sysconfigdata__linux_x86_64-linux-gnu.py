...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/home/server-iss-mbkm/project/customer_churn/venv/bin',
 'BINLIBDEST': '/home/server-iss-mbkm/project/customer_churn/venv/lib/python3.9',
 'BLDLIBRARY': 'libpython3.9.a',
 'BLDSHARED': ''
              'gcc -pthread -B /home/server-iss-mbkm/project/customer_churn/venv/compiler_compat -Wl,--sysroot=/ -shared  '
              ''
              ''
              '-Wl,-rpath,/home/server-iss-mbkm/project/customer_churn/venv/lib '
              '-Wl,-rpath-link,/home/server-iss-mbkm/project/customer_churn/venv/lib '
              '-L/home/server-iss-mbkm/project/customer_churn/venv/lib '
              ''
              ''
              '-Wl,-rpath,/home/server-iss-mbkm/project/customer_churn/venv/lib '
              '-Wl,-rpath-link,/home/server-iss-mbkm/project/customer_churn/venv/lib '
 ...
 'BYTESTR_DEPS': '\\',
 'CC': ''
       'gcc -pthread -B /home/server-iss-mbkm/project/customer_churn/venv/compiler_compat -Wl,--sysroot=/',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG  -O2 -Wall '
           '   -fPIC '
           '  -O2   '
           '-isystem '
           '/home/server-iss-mbkm/project/customer_churn/venv/include '
           ''
           ''
           ''
           '   -fPIC '
 ...
 'CONFIGURE_CPPFLAGS': '-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem '
                       '/home/server-iss-mbkm/project/customer_churn/venv/include '
                       '-I/home/server-iss-mbkm/project/customer_churn/venv/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      '-Wl,-rpath,/home/server-iss-mbkm/project/customer_churn/venv/lib '
                      '-Wl,-rpath-link,/home/server-iss-mbkm/project/customer_churn/venv/lib '
 ...
 'CONFIGURE_LDFLAGS_NODIST': ''
                             ' -g',
 'CONFIG_ARGS': "'--prefix=/home/server-iss-mbkm/project/customer_churn/venv' "
                "'--build=x86_64-conda_cos6-linux-gnu' "
                "'--host=x86_64-conda_cos6-linux-gnu''--enable-ipv6' "
                "'--with-ensurepip=no' "
                "'--with-tzpath=/home/server-iss-mbkm/project/customer_churn/venv/share/zoneinfo:/home/server-iss-mbkm/project/customer_churn/venv/share/tzinfo' "
                "'--with-computed-gotos''--with-system-ffi' "
                "'--enable-loadable-sqlite-extensions' "
                "'--with-tcltk-includes=-I/home/server-iss-mbkm/project/customer_churn/venv/include' "
                "'--with-tcltk-libs=-L/home/server-iss-mbkm/project/customer_churn/venv/lib "
                ...
                "'PKG_CONFIG_PATH=/home/server-iss-mbkm/project/customer_churn/venv/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/home/server-iss-mbkm/project/customer_churn/venv/include',
 'CONFINCLUDEPY': '/home/server-iss-mbkm/project/customer_churn/venv/include/python3.9',
 'COREPYTHONPATH': '',
 ...
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             ...
             '/home/server-iss-mbkm/project/customer_churn/venv/include '
             '-I/home/server-iss-mbkm/project/customer_churn/venv/include',
 'CXX': 'g++ -pthread -B /home/server-iss-mbkm/project/customer_churn/venv/compiler_compat -Wl,--sysroot=/',
 'DESTDIRS': '/home/server-iss-mbkm/project/customer_churn/venv '
             '/home/server-iss-mbkm/project/customer_churn/venv/lib '
             '/home/server-iss-mbkm/project/customer_churn/venv/lib/python3.9 '
             '/home/server-iss-mbkm/project/customer_churn/venv/lib/python3.9/lib-dynload',
 'DESTLIB': '/home/server-iss-mbkm/project/customer_churn/venv/lib/python3.9',
 'DESTPATH': '',
 'DESTSHARED': '/home/server-iss-mbkm/project/customer_churn/venv/lib/python3.9/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/home/server-iss-mbkm/project/customer_churn/venv/include '
                   '/home/server-iss-mbkm/project/customer_churn/venv/include '
                   '/home/server-iss-mbkm/project/customer_churn/venv/include/python3.9 '
                   '/home/server-iss-mbkm/project/customer_churn/venv/include/python3.9',
 'INCLUDEDIR': '/home/server-iss-mbkm/project/customer_churn/venv/include',
 'INCLUDEPY': '/home/server-iss-mbkm/project/customer_churn/venv/include/python3.9',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -pthread -B /home/server-iss-mbkm/project/customer_churn/venv/compiler_compat -Wl,--sysroot=/ -shared',
 'LDFLAGS': ''
            ''
            '-Wl,-rpath,/home/server-iss-mbkm/project/customer_churn/venv/lib '
            '-Wl,-rpath-link,/home/server-iss-mbkm/project/customer_churn/venv/lib '
 ...
 'LDVERSION': '3.9',
 'LIBC': '',
 'LIBDEST': '/home/server-iss-mbkm/project/customer_churn/venv/lib/python3.9',
 'LIBDIR': '/home/server-iss-mbkm/project/customer_churn/venv/lib',
 'LIBFFI_INCLUDEDIR': '/home/server-iss-mbkm/project/customer_churn/venv/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/server-iss-mbkm/project/customer_churn/venv/lib/pkgconfig',
 'LIBPL': '/home/server-iss-mbkm/project/customer_churn/venv/lib/python3.9/config-3.9-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/home/server-iss-mbkm/project/customer_churn/venv/lib/python3.9',
 ...
 'MANDIR': '/home/server-iss-mbkm/project/customer_churn/venv/share/man',
 'MKDIR_P': '/bin/mkdir -p',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/home/server-iss-mbkm/project/customer_churn/venv/include',
 'OPENSSL_LDFLAGS': '-L/home/server-iss-mbkm/project/customer_churn/venv/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/home/server-iss-mbkm/project/customer_churn/venv/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TCLTK_INCLUDES': '-I/home/server-iss-mbkm/project/customer_churn/venv/include',
 'TCLTK_LIBS': '-L/home/server-iss-mbkm/project/customer_churn/venv/lib '
               '-ltcl8.6 -ltk8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': './python',
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/home/server-iss-mbkm/project/customer_churn/venv/share/zoneinfo:/home/server-iss-mbkm/project/customer_churn/venv/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 'UPDATE_FILE': 'python3 '
 ...
 'datarootdir': '/home/server-iss-mbkm/project/customer_churn/venv/share',
 'exec_prefix': '/home/server-iss-mbkm/project/customer_churn/venv',
